...
这个测试本身不是最终产品，而是网球约球/打球平台的冷启动入口：先用低门槛测试完成传播、兴趣识别和玩家标签沉淀，再逐步承接到找球友、约时间、约场地、组织对局的真实打球流程。
...
- 用户球技、风格、常出没区域和可打球时间档案。
- 单打、双打、练球、休闲局等约球发布与加入流程。
- 对局创建、报名、确认、取消、结束反馈的完整生命周期。
- 将测试结果、分享海报和社区传播导向真实线下打球。
